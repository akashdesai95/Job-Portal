...
<body>
    ...
    <form action="\PHPProject\registervalidate.php" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
        ...
        <div class="col-sm-10">
        <input type="text" name="username" class="form-control" id="usr" placeholder="Type Username (maximum length : 10 chars and only letters and white spaces allowed)" autofocus required >
        </div>
        </div>

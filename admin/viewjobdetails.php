...
echo "<br><br>";
if($row1->closejob=="removed"){
	echo "Job is removed";
}else if($row1->closejob=="blocked"){
	echo "Account closed";
	...
	echo "<a href=\"unblockjob.php?job_id=".$_GET['job_id']."\">Unblock this job</a>";
}else{
	echo "<a href=\"blockjob.php?job_id=".$_GET['job_id']."\">Block this job</a>";
}

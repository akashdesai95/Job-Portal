...
<body>
   ...
   <form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);   ?>" method="GET" class="form-horizontal" role="form">
    ...
    <div class="row">
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Accounting">Accounting</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Bank">Bank</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Consultant">Consultant</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Ecommerce">Ecommerce</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Engineering">Engineering</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=FMCG">FMCG</a></div>
    </div>
    <div class="row">
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Insurance">Insurance</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=IT">IT</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Media">Media</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Medical">Medical</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Real Estate">Real Estate</a></div>
        <div class="col-sm-2"><a class="btn btn-default" href="\PHPProject\searchby.php?msg=Others">Others</a></div>
    </div>
    </div>
        ...
        if(!$conn)
         ...
         if(mysqli_num_rows($result) > 0){
            while( $row = mysqli_fetch_assoc($result)){
               ...
               echo "<form action=\"\PHPProject\\jobprofile.php\" method=\"GET\">";

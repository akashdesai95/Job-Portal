...
<body>
   ...
   <?php 
    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0)
        {
            while( $row = mysqli_fetch_assoc($result)){
                echo "<tr><img src=\"\\PHPProject\\propic\\".$row["email"].".".$row["propic"]."\" alt=\"propic\" height=\"150\" width=\"150\"></tr><br/><br/><td>Username : </td><td>".$row["username"]."</td></tr><tr><td>Birthday : </td><td>".$row["birthday"]."</td></tr><tr><td>Email Id : </td><td>".$row["email"]."</td></tr><tr><td>Mobile Number : </td><td>".$row["number"]."</td></tr>";
            }
        } else{
    ...
    <div class="container text-center">
    <a href="\PHPProject\profileedit.php" class="btn btn-default">Edit Your Profile</a>
    </div>

...
<body>
   ...
   <?php 
    ...
    <br/><br/><br/>
    <div class="container">
    <form action="\PHPProject\profilealter.php" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
        ...
        <div class="form-group">
        <label class="control-label col-sm-2" for="bdate">Birthday : </label>
        <div class="col-sm-10">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
        <label class="control-label col-sm-2" for="logos">Set Profile Picture : </label>
        <div class="col-sm-10">
